...
// ── CohortFeedItem ───────────────────────────────────────────
const COHORT_FEED = [
  { name: 'Amara K.', avatar: window.__resources.avatar47, action: 'submitted Report 1 for Mentor Review 8', phase: 'p8', time: '12 min ago' },
  { name: 'Takeshi R.', avatar: window.__resources.avatar12, action: 'completed Adjustment Grid · 4 overrides defended', phase: 'p5', time: '38 min ago' },
  { name: 'Priya N.',  avatar: window.__resources.avatar45, action: 'cleared Mentor Review 3 (Market & HBU)', phase: 'p3', time: '1 hr ago' },
  { name: 'Diego A.',  avatar: window.__resources.avatar33, action: 'finalized GLA in Apex Sketch · 2,148 sq ft', phase: 'p2', time: '2 hr ago' },
  { name: 'Lena O.',   avatar: window.__resources.avatar49, action: 'opened comp selection · MLS scan', phase: 'p4', time: '3 hr ago' },
  { name: 'Marcus P.', avatar: window.__resources.avatar15, action: 'AI flagged USPAP SR1-3 · revising HBU', phase: 'p3', time: '4 hr ago' },
  { name: 'Yuki T.',   avatar: window.__resources.avatar44, action: 'started Report 2 · FHA Refinance', phase: 'p1', time: '5 hr ago' },
];
...
const SUBJECT = {
  ...
  photo: window.__resources.heroProperty,
...
const COMPS = [
  { id: 'C1', address: '4109 Ridgewood Ln', dist: 0.18, gla: 2090, beds: 4, baths: 2.5, age: 17, sale: 478000, sold: '2026-02-14', dom: 9, aiScore: 96, photo: window.__resources.comp1 },
  { id: 'C2', address: '3884 Cedar Hollow Dr', dist: 0.42, gla: 2210, beds: 4, baths: 3, age: 16, sale: 495000, sold: '2026-01-28', dom: 14, aiScore: 92, photo: window.__resources.comp2 },
  { id: 'C3', address: '4502 Birchwood Ct', dist: 0.31, gla: 2055, beds: 4, baths: 2.5, age: 19, sale: 466000, sold: '2025-12-08', dom: 21, aiScore: 89, photo: window.__resources.comp5 },
  { id: 'C4', address: '4071 Glen Ridge Way', dist: 0.55, gla: 2240, beds: 5, baths: 3, age: 14, sale: 512000, sold: '2026-03-02', dom: 6, aiScore: 87, photo: window.__resources.comp3 },
  { id: 'C5', address: '3922 Maple Crest Dr', dist: 0.68, gla: 1980, beds: 3, baths: 2.5, age: 18, sale: 449000, sold: '2026-01-04', dom: 18, aiScore: 78, photo: window.__resources.comp4 },
];

const MENTOR = {
  name: 'James Mendel, MAI',
  role: 'Lead Mentor · Cohort 04',
  avatar: window.__resources.avatar68L,
  yearsExperience: 23,
...
const PERSONAS = {
  maya: {
    ...
    avatar: window.__resources.avatar48L,
    tone: 'Professional, deal-pressured',
  },
  david: {
    name: 'David Osei',
    role: 'Homeowner · 4218 Ridgewood Ln',
    avatar: window.__resources.avatar59L,
