// PAREA Combined — Screens 1-11 (Pre-Program + Phase 1)
        ...
        <button onClick={() => setOpen(o => !o)} style={{
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 12, color: '#888', marginTop: 3, display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <strong style={{ color: '#d60436' }}>Phase {currentIdx + 1} of 8</strong>
              ...
              {PHASES.slice(1).map((p, i) => {
                ...
                return (
                  <div key={p.id} title={p.label} style={{
                    ...
                    <div style={{ fontSize: 9.5, opacity: 0.75, letterSpacing: '.04em' }}>PHASE</div>
                    <div style={{ fontSize: 13, fontFamily: "'Nunito', sans-serif", fontWeight: 800 }}>{i + 1}</div>
                  </div>
                );
              })}
            </div>
            {/* Open format: flowing chips with phase names */}
...
// ═══ SCREEN 4: Phase 1 Intro ═════════════════════════════════
function S04_Phase1Intro({ navigate }) {
  return (
    <div>
      <PageHeader breadcrumb={['Report 1', 'Phase 1 · Problem ID']} title="Section I & II — Frame the assignment"
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
        ...
        <Card padding="18px 20px" style={{ background: '#fafbfc' }}>
          <div style={{ fontSize: 10, fontWeight: 800, color: '#d60436', letterSpacing: '.08em', textTransform: 'uppercase' }}>AI in this phase</div>
...
function S05_Ethics({ navigate }) {
  ...
  return (
    <div style={{ maxWidth: 880, margin: '0 auto' }}>
      <PageHeader breadcrumb={['Phase 1', 'Section I.A']} title="Ethics & independence"
...
function S06_ToolOrientation({ navigate }) {
  ...
  return (
    <div style={{ maxWidth: 920, margin: '0 auto' }}>
      <PageHeader breadcrumb={['Phase 1', 'Section I.B']} title="Tool orientation"
...
function S07_Engagement({ navigate, tweaks }) {
  ...
  return (
    <div>
      <PageHeader breadcrumb={['Phase 1', 'Section II.A']} title="Engagement letter — Maya Chen"
...
function S08_PrelimResearch({ navigate }) {
  ...
  return (
    <div>
      <PageHeader breadcrumb={['Phase 1', 'Section II.C']} title="Preliminary research"
...
function S09_InspectionScheduling({ navigate }) {
  return (
    <div style={{ maxWidth: 880, margin: '0 auto' }}>
      <PageHeader breadcrumb={['Phase 1', 'Section II.D']} title="Inspection scheduling — David Osei"
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 16 }}>
        ...
        <Button variant="primary" onClick={() => navigate('mentor-review-1')}>
          Submit Phase 1 · Mentor Review 1 <Icon name="arrow-right" size={14} color="#fff"/>
        </Button>
      </div>
    </div>
  );
...
function S10_MentorReview1({ navigate, tweaks }) {
  ...
  return (
    <div>
      <PageHeader breadcrumb={['Phase 1', 'Mentor Review 1']} title="Mentor Review 1 — Pre-screen"
        subtitle="The AI pre-screens everything from Phase 1. Mentor sees a clean summary, not raw work. This is how we hold 1:20 mentor coverage."/>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: 16 }}>
        <Card padding={0}>
          <div style={{ padding: '14px 18px', background: '#fafbfc', borderBottom: '1px solid #eee', display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div style={{ fontSize: 13, fontWeight: 700, flex: 1, color: '#292929' }}>Phase 1 readiness · 4 of 5 ready</div>
          ...
          <div style={{ padding: 18 }}>
            ...
            <div style={{ background: '#fffbf2', border: '1px solid #e8860a33', borderRadius: 8, padding: 14, marginBottom: 12 }}>
              ...
              <div style={{ fontSize: 13, color: '#444', lineHeight: 1.55 }}>
                Your Phase 1 work is solid. The engagement letter is tight and your inspection scheduling caught the tenant — well done. <strong style={{ color: '#d60436' }}>One flag</strong>: you didn't note the USPAP edition in the letter. James will likely ask about this — fix before the meeting and you'll be set.
              </div>
            </div>
